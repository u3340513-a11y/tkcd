 ...
 * Statik veri — dış API bağımlılığı yok.
 * Kaynak: NVİ resmi idari bölünüş listesi.
 */
const TURKIYE_ILCELER = {
    ...
    "Aydın": ["Bozdoğan", "Buharkent", "Çine", "Didim", "Efeler", "Germencik", "İncirliova", "Karacasu", "Koçarlı", "Köşk", "Kuşadası", "Kuyucak", "Nazilli", "Söke", "Sultanhisar", "Yenipazar"],
    ...
    "Yozgat": ["Akdağmadeni", "Aydıncık", "Boğazlıyan", "Çandır", "Çayıralan", "Çekerek", "Kadışehri", "Merkez", "Saraykent", "Sarıkaya", "Şefaatli", "Sorgun", "Yahyalı", "Yenifakılı", "Yerköy"],
